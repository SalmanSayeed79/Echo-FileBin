...
export default function Lectures(match) {
    ...
    if(!loggedIn){
        ...
        <div className="subjectPage">
            ...
            <div className="add-file">
                    <h2>Add Lecture Sheet</h2>
                    <form id="add-form">
                        <input type="text" name="name" placeholder="Topic Name"/>
                        <input type="text" name="writer" placeholder="Lecture Date"/>
                        <input type="text" name="url" placeholder="Enter the url"/>
                        <button onClick={e=>addData(e)}>Add Lecture Sheet</button>
